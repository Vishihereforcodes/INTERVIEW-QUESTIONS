...
2. Code:- At every index we will check the equality of letters, if they are equal then the length will be previous length + 1, else will initialise length with zero
